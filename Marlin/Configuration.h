...
#define STRING_CONFIG_H_AUTHOR "CXDezign" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "CX3D"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
                                  // Set/get with G-code: M301 [Eextruder number, 0-2]

  #if ENABLED(PID_PARAMS_PER_HOTEND)
    // Specify up to one value per hotend here, according to your setup.
    // If there are fewer values, the last one applies to the remaining hotends.
    #define DEFAULT_Kp_LIST { 14.62, 14.62 }
    #define DEFAULT_Ki_LIST { 1.19, 1.19 }
    #define DEFAULT_Kd_LIST { 45.00, 45.00 }
  #else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 121.12
  #define DEFAULT_bedKi 23.67
  #define DEFAULT_bedKd 413.09
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 40, 100 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, -40, -4.2 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_DEFAULT_PATTERN 2
