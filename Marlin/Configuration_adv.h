 ...
 */
//#define REDUNDANT_PART_COOLING_FAN 2  // Index of the first fan to synchronize with Fan 0
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 250*60, 250*60, 40*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define EVENT_GCODE_SD_ABORT "G91\nG0 Z20\nG90\nG0 X0 Y225"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define Z_CURRENT       (580*2) // Dual Z Axis, Single Z Stepper Motor Current * 2
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Preset Functions"
  // #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  //#define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle
  #define MAIN_MENU_ITEM_1_DESC "Restart Motherboard"

  #define MAIN_MENU_ITEM_1_GCODE "M997"
  #define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Home & ABL"
  ...
  // #define MAIN_MENU_ITEM_4_DESC "Preheat for " PREHEAT_1_LABEL
  // #define MAIN_MENU_ITEM_4_GCODE "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)
  //#define MAIN_MENU_ITEM_4_CONFIRM

  //#define MAIN_MENU_ITEM_5_DESC "Preheat for " PREHEAT_2_LABEL
  //#define MAIN_MENU_ITEM_5_GCODE "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND)
  //#define MAIN_MENU_ITEM_5_CONFIRM

  //#define MAIN_MENU_ITEM_6_DESC "Heat Bed/Home/Level"
  //#define MAIN_MENU_ITEM_6_GCODE "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nG28\nG29"
  //#define MAIN_MENU_ITEM_6_CONFIRM

  //#define MAIN_MENU_ITEM_7_DESC "Home & Info"
